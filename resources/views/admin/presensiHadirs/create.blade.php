...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.presensiHadir.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.presensi-hadirs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('checktime') ? 'is-invalid' : '' }}" type="text" name="checktime" id="checktime" value="{{ old('checktime') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('koordinat') ? 'is-invalid' : '' }}" type="text" name="koordinat" id="koordinat" value="{{ old('koordinat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_code') ? 'is-invalid' : '' }}" type="text" name="work_code" id="work_code" value="{{ old('work_code', '') }}">
