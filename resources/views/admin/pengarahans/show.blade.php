...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <div class="form-group"><a href="{{route('admin.pengarahansuratmasuks.index')}}"
                    class="btn btn-default">Kembali</a></div>
            @else
            <div class="form-group"><a href="{{route('admin.pengarahansuratkeluars.index')}}"
                    class="btn btn-default">Kembali</a></div>
            @endif
        </div>
