...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.suratmasuks.update', [$surat->id])}}" method="POST" enctype="multipart/form-data">
            @else
            <form action="{{route('admin.suratkeluars.update', [$surat->id])}}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_surat" type="text" class="form-control date" placeholder="Tanggal Surat"
                ...
                <div class="form-group">
                    ...
                    <input name="pengirim" type="text" class="form-control" placeholder="pengirim"
                        value="{{old('pengirim', $surat->pengirim)}}" required>
                </div>
                @endif
                <div class="form-group">
                    <label class="required" for="hal">Perihal</label>
                    <input name="hal" type="text" class="form-control" placeholder="hal"
                        value={{old('hal', $surat->hal)}} required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="penerima" type="text" class="form-control" placeholder="Penerima"
                        value="{{old('hal', $surat->penerima)}}" required>
                </div>
                @endif
                <div class="form-group">
