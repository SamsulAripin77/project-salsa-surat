...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.unit-kerjas.update", [$unitKerja->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nama_unit_kerja">{{ trans('cruds.unitKerja.fields.nama_unit_kerja') }}</label>
                <input class="form-control {{ $errors->has('nama_unit_kerja') ? 'is-invalid' : '' }}" type="text" name="nama_unit_kerja" id="nama_unit_kerja" value="{{ old('nama_unit_kerja', $unitKerja->nama_unit_kerja) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" type="text" name="keterangan" id="keterangan" value="{{ old('keterangan', $unitKerja->keterangan) }}">
