    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shifts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_shift') ? 'is-invalid' : '' }}" type="text" name="nama_shift" id="nama_shift" value="{{ old('nama_shift', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('checkin') ? 'is-invalid' : '' }}" type="text" name="checkin" id="checkin" value="{{ old('checkin') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('checkout') ? 'is-invalid' : '' }}" type="text" name="checkout" id="checkout" value="{{ old('checkout') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('smsin') ? 'is-invalid' : '' }}" type="text" name="smsin" id="smsin" value="{{ old('smsin') }}">
                @if($errors->has('smsin'))
                    <div class="invalid-feedback">
                        {{ $errors->first('smsin') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('smsout') ? 'is-invalid' : '' }}" type="text" name="smsout" id="smsout" value="{{ old('smsout') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_over_time') ? 'is-invalid' : '' }}" type="text" name="is_over_time" id="is_over_time" value="{{ old('is_over_time', '') }}">
