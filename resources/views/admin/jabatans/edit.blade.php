    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.jabatans.update", [$jabatan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_jabatan') ? 'is-invalid' : '' }}" type="text" name="nama_jabatan" id="nama_jabatan" value="{{ old('nama_jabatan', $jabatan->nama_jabatan) }}" required>
