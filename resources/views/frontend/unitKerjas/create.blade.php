    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.unit-kerjas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nama_unit_kerja">{{ trans('cruds.unitKerja.fields.nama_unit_kerja') }}</label>
                            <input class="form-control" type="text" name="nama_unit_kerja" id="nama_unit_kerja" value="{{ old('nama_unit_kerja', '') }}" required>
