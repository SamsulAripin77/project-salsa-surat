                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shifts.update", [$shift->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_shift" id="nama_shift" value="{{ old('nama_shift', $shift->nama_shift) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkin" id="checkin" value="{{ old('checkin', $shift->checkin) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkout" id="checkout" value="{{ old('checkout', $shift->checkout) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="smsin" id="smsin" value="{{ old('smsin', $shift->smsin) }}">
                            @if($errors->has('smsin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('smsin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="smsout" id="smsout" value="{{ old('smsout', $shift->smsout) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_over_time" id="is_over_time" value="{{ old('is_over_time', $shift->is_over_time) }}">
