    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shifts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nama_shift">{{ trans('cruds.shift.fields.nama_shift') }}</label>
                            <input class="form-control" type="text" name="nama_shift" id="nama_shift" value="{{ old('nama_shift', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkin" id="checkin" value="{{ old('checkin') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkout" id="checkout" value="{{ old('checkout') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="smsin" id="smsin" value="{{ old('smsin') }}">
                            @if($errors->has('smsin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('smsin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="smsout" id="smsout" value="{{ old('smsout') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_over_time" id="is_over_time" value="{{ old('is_over_time', '') }}">
