    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hari-liburs.update", [$hariLibur->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="tgl">{{ trans('cruds.hariLibur.fields.tgl') }}</label>
                            <input class="form-control date" type="text" name="tgl" id="tgl" value="{{ old('tgl', $hariLibur->tgl) }}">
                            @if($errors->has('tgl'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="keterangan" id="keterangan" value="{{ old('keterangan', $hariLibur->keterangan) }}">
