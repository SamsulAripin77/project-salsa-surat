    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.presensi-tidak-hadirs.update", [$presensiTidakHadir->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="cdate">{{ trans('cruds.presensiTidakHadir.fields.cdate') }}</label>
                            <input class="form-control date" type="text" name="cdate" id="cdate" value="{{ old('cdate', $presensiTidakHadir->cdate) }}">
                            @if($errors->has('cdate'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="keterangan_lanjut" id="keterangan_lanjut" value="{{ old('keterangan_lanjut', $presensiTidakHadir->keterangan_lanjut) }}">
