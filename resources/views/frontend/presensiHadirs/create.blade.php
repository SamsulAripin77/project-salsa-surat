    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.presensi-hadirs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="checktime" id="checktime" value="{{ old('checktime') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="work_code" id="work_code" value="{{ old('work_code', '') }}">
