...
class PresensiHadirController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.presensiHadirs.index', compact('presensiHadirs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.presensiHadirs.create', compact('userids'));
    }
    ...
    public function store(StorePresensiHadirRequest $request)
    {
        ...
        return redirect()->route('frontend.presensi-hadirs.index');
    }
    ...
    public function edit(PresensiHadir $presensiHadir)
    {
        ...
        return view('frontend.presensiHadirs.edit', compact('userids', 'presensiHadir'));
    }
    ...
    public function show(PresensiHadir $presensiHadir)
    {
        ...
        return view('frontend.presensiHadirs.show', compact('presensiHadir'));
    }
