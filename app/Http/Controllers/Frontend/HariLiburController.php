...
class HariLiburController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.hariLiburs.index', compact('hariLiburs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.hariLiburs.create');
    }
    ...
    public function store(StoreHariLiburRequest $request)
    {
        ...
        return redirect()->route('frontend.hari-liburs.index');
    }
    ...
    public function edit(HariLibur $hariLibur)
    {
        ...
        return view('frontend.hariLiburs.edit', compact('hariLibur'));
    }
    ...
    public function show(HariLibur $hariLibur)
    {
        ...
        return view('frontend.hariLiburs.show', compact('hariLibur'));
    }
