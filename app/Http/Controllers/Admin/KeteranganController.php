...
class KeteranganController extends Controller
{
    public function index()
    {
        ...
        return view('admin.keterangans.index', compact('keterangans'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.keterangans.create');
    }
    ...
    public function store(StoreKeteranganRequest $request)
    {
        ...
        return redirect()->route('admin.keterangans.index');
    }
    ...
    public function edit(Keterangan $keterangan)
    {
        ...
        return view('admin.keterangans.edit', compact('keterangan'));
    }
    ...
    public function show(Keterangan $keterangan)
    {
        ...
        return view('admin.keterangans.show', compact('keterangan'));
    }
