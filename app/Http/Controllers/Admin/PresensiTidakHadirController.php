...
class PresensiTidakHadirController extends Controller
{
    public function index()
    {
        ...
        return view('admin.presensiTidakHadirs.index', compact('presensiTidakHadirs'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.presensiTidakHadirs.create', compact('id_pegawais', 'keterangans'));
    }
    ...
    public function store(StorePresensiTidakHadirRequest $request)
    {
        ...
        return redirect()->route('admin.presensi-tidak-hadirs.index');
    }
    ...
    public function edit(PresensiTidakHadir $presensiTidakHadir)
    {
        ...
        return view('admin.presensiTidakHadirs.edit', compact('id_pegawais', 'keterangans', 'presensiTidakHadir'));
    }
    ...
    public function show(PresensiTidakHadir $presensiTidakHadir)
    {
        ...
        return view('admin.presensiTidakHadirs.show', compact('presensiTidakHadir'));
    }
